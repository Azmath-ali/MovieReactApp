  ...
  >
      ...
      <div className='w-full flex p-4 text-white '>
        ...
        <div className='w-[75%] ml-[5%] '>
          ...
          <h1 className='w-full  text-5xl text-white font-black'>  {information.detail.original_title || information.detail.title }
            ...
            <span>({information.detail.release_date.split("-")[0]})</span>
          ...
          <h1> {information.detail.runtime} mins  </h1>
      ...
      <div className='text-white'>
        ...
        <div className='flex items-center gap-5 mt-5'>
          ...
          { information.watchproviders && information.watchproviders.buy &&  information.watchproviders.buy.map((val,index)=>
